...
(function UMDish(name, context, definition) {
  ...
  function Primus(url, options) {
    ...
    options.ping = 'ping' in options ? options.ping : 0;
  ...
  Primus.prototype.uri = function uri(options) {
    ...
    options.port = 'port' in options
      ? +options.port
      : +url.port || (options.secure ? 443 : 4100);
...
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("timers").setImmediate,require("timers").clearImmediate)
...
},{"./primus":2,"primus-emit":1}],4:[function(require,module,exports){
...
},{"./web-socket":3}],5:[function(require,module,exports){
